...
import { v as vueExports, s as ssrRenderComponent_1, c as ssrInterpolate_1, h as ssrRenderAttrs_1 } from '../routes/renderer.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs_1(vueExports.mergeProps({ class: "overflow-hidden rounded-[1.5rem] border border-charcoal-200 bg-white/90" }, _attrs))}>`);
      _push(ssrRenderComponent_1(_component_UTable, {
        columns,
        data: props.items,
        ...
        "customer_name-cell": vueExports.withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="space-y-1"${_scopeId}><p class="font-medium text-charcoal-950"${_scopeId}>${ssrInterpolate_1(row.original.customer_name || "Клиент без записи")}</p><p class="text-xs text-charcoal-500"${_scopeId}>${ssrInterpolate_1(row.original.phone_number || "Телефон не указан")}</p></div>`);
          } else {
            return [
              vueExports.createVNode("div", { class: "space-y-1" }, [
                vueExports.createVNode("p", { class: "font-medium text-charcoal-950" }, vueExports.toDisplayString(row.original.customer_name || "Клиент без записи"), 1),
                vueExports.createVNode("p", { class: "text-xs text-charcoal-500" }, vueExports.toDisplayString(row.original.phone_number || "Телефон не указан"), 1)
              ])
            ];
          }
        }),
        "status-cell": vueExports.withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent_1(_component_SharedStatusBadge, {
        ...
        "payment_method-cell": vueExports.withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span${_scopeId}>${ssrInterpolate_1(vueExports.unref(formatPaymentMethod)(row.original.payment_method))}</span>`);
          } else {
            return [
              vueExports.createVNode("span", null, vueExports.toDisplayString(vueExports.unref(formatPaymentMethod)(row.original.payment_method)), 1)
            ];
          }
        }),
        "amount-cell": vueExports.withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="font-medium"${_scopeId}>${ssrInterpolate_1(vueExports.unref(formatMoney)(row.original.amount))}</span>`);
          } else {
            return [
              vueExports.createVNode("span", { class: "font-medium" }, vueExports.toDisplayString(vueExports.unref(formatMoney)(row.original.amount)), 1)
            ];
          }
        }),
        "actions-cell": vueExports.withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent_1(_component_UButton, {
              ...
              default: vueExports.withCtx((_, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  return [
                    vueExports.createTextVNode(" Открыть ")
                  ];
                }
              }),
              _: 2
            ...
            return [
              vueExports.createVNode("div", { class: "flex flex-wrap justify-end gap-2" }, [
...
const _sfc_main = /* @__PURE__ */ vueExports.defineComponent({
  ...
  async setup(__props) {
    ...
    const breakMinutes = vueExports.ref(10);
    useRealtimeQueue();
    [__temp, __restore] = vueExports.withAsyncContext(() => sessionStore.ensureLoaded()), await __temp, __restore();
    const { data, pending, refresh } = ([__temp, __restore] = vueExports.withAsyncContext(async () => useAsyncData("barber-workspace", async () => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent_1(_component_UDashboardPanel, vueExports.mergeProps({ id: "workspace" }, _attrs), {
              ...
              right: vueExports.withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent_1(_component_UBadge, {
                    color: vueExports.unref(sessionStore).barber?.is_on_break ? "warning" : "primary",
                    variant: "soft"
                  }, {
                    default: vueExports.withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`${ssrInterpolate_1(vueExports.unref(sessionStore).barber?.is_on_break ? "На перерыве" : "На смене")}`);
                      } else {
                        return [
                          vueExports.createTextVNode(vueExports.toDisplayString(vueExports.unref(sessionStore).barber?.is_on_break ? "На перерыве" : "На смене"), 1)
                        ];
                      }
                    }),
                    _: 1
        ...
        body: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent_1(_component_DashboardMetricCard, {
              ...
              value: vueExports.unref(data)?.queue?.count || 0
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent_1(_component_DashboardMetricCard, {
              description: "Контекст филиала, назначенный барберу.",
              icon: "i-lucide-map-pinned",
              label: "Филиал",
              value: vueExports.unref(sessionStore).barber?.branch_id || "Неизвестно"
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent_1(_component_DashboardMetricCard, {
              description: "Дополнительный индикатор нагрузки из состава киоска.",
              icon: "i-lucide-users-round",
              label: "Текущие клиенты",
              value: vueExports.unref(sessionStore).barber?.current_clients || 0
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent_1(_component_DashboardMetricCard, {
              description: "Оценка времени ожидания по данным бэкенда.",
              icon: "i-lucide-timer",
              label: "Оценка ожидания",
              value: `${vueExports.unref(sessionStore).barber?.estimated_waiting_time || 0} мин`
            }, null, _parent2, _scopeId));
            ...
            _push2(ssrRenderComponent_1(_component_UCard, { class: "warm-card rounded-[1.9rem] border border-charcoal-200" }, {
              header: vueExports.withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="space-y-2"${_scopeId2}><p class="text-xs font-semibold uppercase tracking-[0.24em] text-charcoal-500"${_scopeId2}> Профиль </p><h2 class="barbershop-heading text-3xl text-charcoal-950"${_scopeId2}>${ssrInterpolate_1(vueExports.unref(sessionStore).user?.name || "Сессия барбера")}</h2></div>`);
                } else {
                  return [
                    vueExports.createVNode("div", { class: "space-y-2" }, [
                      vueExports.createVNode("p", { class: "text-xs font-semibold uppercase tracking-[0.24em] text-charcoal-500" }, " Профиль "),
                      vueExports.createVNode("h2", { class: "barbershop-heading text-3xl text-charcoal-950" }, vueExports.toDisplayString(vueExports.unref(sessionStore).user?.name || "Сессия барбера"), 1)
                    ])
                  ];
                }
              }),
                ...
                if (_push3) {
                    ...
                    default: vueExports.withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent_1(_component_UInput, {
                          modelValue: vueExports.unref(breakMinutes),
                          "onUpdate:modelValue": ($event) => vueExports.isRef(breakMinutes) ? breakMinutes.value = $event : null,
                          min: "1",
                          type: "number"
                  ...
                  _push3(ssrRenderComponent_1(_component_UButton, {
                    ...
                    default: vueExports.withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        return [
                          vueExports.createTextVNode(" Начать перерыв ")
                        ];
                      }
                    }),
                    _: 1
                  ...
                  _push3(ssrRenderComponent_1(_component_UButton, {
                    ...
                    default: vueExports.withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        return [
                          vueExports.createTextVNode(" Вернуться ")
                        ];
                      }
                    }),
                    _: 1
                  ...
                  return [
                    vueExports.createVNode("div", { class: "space-y-5" }, [
                      vueExports.createVNode("div", { class: "grid gap-3 sm:grid-cols-2" }, [
                        vueExports.createVNode("div", { class: "rounded-[1.25rem] border border-charcoal-200 bg-white/80 p-4" }, [
                          vueExports.createVNode("p", { class: "text-xs font-semibold uppercase tracking-[0.2em] text-charcoal-500" }, "Логин"),
                          vueExports.createVNode("p", { class: "mt-2 text-lg font-semibold text-charcoal-950" }, vueExports.toDisplayString(vueExports.unref(sessionStore).user?.login || "Не указан"), 1)
                        ]),
                        vueExports.createVNode("div", { class: "rounded-[1.25rem] border border-charcoal-200 bg-white/80 p-4" }, [
                          vueExports.createVNode("p", { class: "text-xs font-semibold uppercase tracking-[0.2em] text-charcoal-500" }, "Специализация"),
                          vueExports.createVNode("p", { class: "mt-2 text-lg font-semibold text-charcoal-950" }, vueExports.toDisplayString(vueExports.unref(sessionStore).barber?.specialization || "Общие услуги"), 1)
                        ])
                      ]),
                      vueExports.createVNode("div", { class: "space-y-3 rounded-[1.5rem] border border-charcoal-200 bg-white/80 p-4" }, [
                        vueExports.createVNode("p", { class: "text-xs font-semibold uppercase tracking-[0.2em] text-charcoal-500" }, "Управление перерывом"),
            ...
            _push2(ssrRenderComponent_1(_component_UCard, { class: "warm-card rounded-[1.9rem] border border-charcoal-200" }, {
              header: vueExports.withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  return [
                    vueExports.createVNode("div", { class: "space-y-2" }, [
                      vueExports.createVNode("p", { class: "text-xs font-semibold uppercase tracking-[0.24em] text-charcoal-500" }, " Активная очередь "),
                      vueExports.createVNode("h2", { class: "barbershop-heading text-3xl text-charcoal-950" }, " Управляйте текущей очередью ")
                    ])
                  ];
                }
              }),
              default: vueExports.withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (vueExports.unref(data)?.queue?.items?.length) {
                    _push3(`<div${_scopeId2}>`);
                    _push3(ssrRenderComponent_1(_component_QueueTable, {
                      items: vueExports.unref(data).queue.items,
                      loading: vueExports.unref(pending),
                      onCall: callItem,
                  ...
                  return [
                    vueExports.unref(data)?.queue?.items?.length ? (vueExports.openBlock(), vueExports.createBlock("div", { key: 0 }, [
                      vueExports.createVNode(_component_QueueTable, {
                        items: vueExports.unref(data).queue.items,
                        loading: vueExports.unref(pending),
                        onCall: callItem,
                        onComplete: completeItem,
