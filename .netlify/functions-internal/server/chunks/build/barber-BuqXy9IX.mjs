...
import { v as vueExports, s as ssrRenderComponent_1, c as ssrInterpolate_1, d as ssrRenderList_1, g as ssrRenderStyle_1 } from '../routes/renderer.mjs';
...
const _sfc_main = /* @__PURE__ */ vueExports.defineComponent({
  ...
  async setup(__props) {
    ...
    const detailModalOpen = vueExports.ref(false);
    const detailPending = vueExports.ref(false);
    const detailError = vueExports.ref("");
    const detailStats = vueExports.ref(null);
    const selectedBarber = vueExports.ref(null);
    ...
    const { data, pending, refresh } = ([__temp, __restore] = vueExports.withAsyncContext(async () => useAsyncData("barber-history-directory", async () => {
    ...
    const barberRows = vueExports.computed(() => data.value?.rows || []);
    const failedBranches = vueExports.computed(() => data.value?.failedBranches || []);
    const paginatedBarbers = vueExports.computed(() => {
    ...
    const detailDescription = vueExports.computed(() => {
    ...
    const detailMetrics = vueExports.computed(() => {
    ...
    const detailFacts = vueExports.computed(() => {
      if (!selectedBarber.value) {
        return [];
      }
      return [
    ...
    const extraDetailRows = vueExports.computed(
    ...
    vueExports.watch(detailModalOpen, (open) => {
      if (!open) {
        detailError.value = "";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent_1(_component_UDashboardPanel, vueExports.mergeProps({ id: "barber-history" }, _attrs), {
        ...
        body: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent_1(_component_UCard, { class: "warm-card rounded-[1.9rem] border border-charcoal-200" }, {
              header: vueExports.withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent_1(_component_UFormField, { label: "Период с" }, {
                    default: vueExports.withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                  ...
                  _push3(ssrRenderComponent_1(_component_UFormField, { label: "Период по" }, {
                    default: vueExports.withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent_1(_component_UInput, {
                  ...
                  _push3(ssrRenderComponent_1(_component_UBadge, {
                    ...
                    default: vueExports.withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`${ssrInterpolate_1(vueExports.unref(barberRows).length)} барберов `);
                      } else {
                        return [
                          vueExports.createTextVNode(vueExports.toDisplayString(vueExports.unref(barberRows).length) + " барберов ", 1)
                        ];
                      }
                    }),
                    _: 1
                  ...
                  _push3(ssrRenderComponent_1(_component_UBadge, {
                    ...
                    default: vueExports.withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`${ssrInterpolate_1(vueExports.unref(branchStore).branches.length)} филиалов `);
                      } else {
                        return [
                          vueExports.createTextVNode(vueExports.toDisplayString(vueExports.unref(branchStore).branches.length) + " филиалов ", 1)
                        ];
                      }
                    }),
                    _: 1
                  }, _parent3, _scopeId2));
                  if (vueExports.unref(failedBranches).length) {
                    _push3(ssrRenderComponent_1(_component_UBadge, {
                      color: "warning",
                      variant: "outline"
                    }, {
                      default: vueExports.withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(` Без live-данных по филиалам: ${ssrInterpolate_1(vueExports.unref(failedBranches).length)}`);
                        } else {
                          return [
                            vueExports.createTextVNode(" Без live-данных по филиалам: " + vueExports.toDisplayString(vueExports.unref(failedBranches).length), 1)
                          ];
                        }
                      }),
                      _: 1
                  ...
                  return [
                    vueExports.createVNode("div", { class: "flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between" }, [
                      vueExports.createVNode("div", { class: "space-y-2" }, [
                        vueExports.createVNode("p", { class: "text-xs font-semibold uppercase tracking-[0.24em] text-charcoal-500" }, " Все филиалы "),
                        vueExports.createVNode("h2", { class: "barbershop-heading text-3xl text-charcoal-950" }, " Полный список барберов "),
                        vueExports.createVNode("p", { class: "text-sm text-charcoal-500" }, " Список строится по всем аккаунтам барберов, а не только по активным профилям kiosk API. ")
                      ]),
                      vueExports.createVNode("div", { class: "grid gap-3 sm:grid-cols-2 xl:grid-cols-[minmax(0,13rem)_minmax(0,13rem)]" }, [
                        vueExports.createVNode(_component_UFormField, { label: "Период с" }, {
                          default: vueExports.withCtx(() => [
                            vueExports.createVNode(_component_UInput, {
                              modelValue: vueExports.unref(uiStore).statisticsRange.start,
                              "onUpdate:modelValue": ($event) => vueExports.unref(uiStore).statisticsRange.start = $event,
                        ...
                        vueExports.createVNode(_component_UFormField, { label: "Период по" }, {
                          default: vueExports.withCtx(() => [
                            vueExports.createVNode(_component_UInput, {
                              modelValue: vueExports.unref(uiStore).statisticsRange.end,
                              "onUpdate:modelValue": ($event) => vueExports.unref(uiStore).statisticsRange.end = $event,
                    ...
                    vueExports.createVNode("div", { class: "mt-4 flex flex-wrap items-center gap-3" }, [
                      ...
                      vueExports.unref(failedBranches).length ? (vueExports.openBlock(), vueExports.createBlock(_component_UBadge, {
                        key: 0,
                        color: "warning",
                        variant: "outline"
                      }, {
                ...
                if (_push3) {
                  if (vueExports.unref(barberRows).length) {
                    ...
                    _push3(ssrRenderComponent_1(_component_UTable, {
                      columns,
                      data: vueExports.unref(paginatedBarbers),
                      loading: vueExports.unref(pending),
                      ui: {
                      ...
                      "name-cell": vueExports.withCtx(({ row }, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="space-y-1"${_scopeId3}><p class="font-semibold text-charcoal-950"${_scopeId3}>${ssrInterpolate_1(row.original.name)}</p><p class="text-xs text-charcoal-500"${_scopeId3}>${ssrInterpolate_1(row.original.specialization || "Специализация не указана")}</p></div>`);
                        } else {
                          return [
                            vueExports.createVNode("div", { class: "space-y-1" }, [
                              vueExports.createVNode("p", { class: "font-semibold text-charcoal-950" }, vueExports.toDisplayString(row.original.name), 1),
                              vueExports.createVNode("p", { class: "text-xs text-charcoal-500" }, vueExports.toDisplayString(row.original.specialization || "Специализация не указана"), 1)
                            ])
                          ];
                        }
                      }),
                      "branchName-cell": vueExports.withCtx(({ row }, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<span class="font-medium text-charcoal-950"${_scopeId3}>${ssrInterpolate_1(row.original.branchName)}</span>`);
                        } else {
                          return [
                            vueExports.createVNode("span", { class: "font-medium text-charcoal-950" }, vueExports.toDisplayString(row.original.branchName), 1)
                          ];
                        }
                      }),
                      "phone-cell": vueExports.withCtx(({ row }, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`${ssrInterpolate_1(row.original.phone || "Не указан")}`);
                        } else {
                          return [
                            vueExports.createTextVNode(vueExports.toDisplayString(row.original.phone || "Не указан"), 1)
                          ];
                        }
                      }),
                      "login-cell": vueExports.withCtx(({ row }, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="space-y-1"${_scopeId3}><p class="font-medium text-charcoal-950"${_scopeId3}>${ssrInterpolate_1(row.original.login || "Не указан")}</p><p class="text-xs text-charcoal-500"${_scopeId3}>${ssrInterpolate_1(row.original.role || "Роль не указана")}</p></div>`);
                        } else {
                          return [
                            vueExports.createVNode("div", { class: "space-y-1" }, [
                              vueExports.createVNode("p", { class: "font-medium text-charcoal-950" }, vueExports.toDisplayString(row.original.login || "Не указан"), 1),
                              vueExports.createVNode("p", { class: "text-xs text-charcoal-500" }, vueExports.toDisplayString(row.original.role || "Роль не указана"), 1)
                            ])
                          ];
                        }
                      }),
                      "isActive-cell": vueExports.withCtx(({ row }, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          _push4(ssrRenderComponent_1(_component_UButton, {
                            ...
                            default: vueExports.withCtx((_3, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                ...
                                return [
                                  vueExports.createTextVNode(" Подробнее ")
                                ];
                              }
                            }),
                            _: 2
                    ...
                    _push3(`</div><div class="flex flex-col gap-3 border-t border-charcoal-200 pt-4 sm:flex-row sm:items-center sm:justify-between"${_scopeId2}><p class="text-sm text-charcoal-500"${_scopeId2}> Показано ${ssrInterpolate_1(vueExports.unref(pageFrom))}-${ssrInterpolate_1(vueExports.unref(pageTo))} из ${ssrInterpolate_1(vueExports.unref(barberRows).length)}</p>`);
                    _push3(ssrRenderComponent_1(_component_UPagination, {
                      ...
                      "show-controls": true,
                      "sibling-count": 1,
                      total: vueExports.unref(barberRows).length
                    ...
                    vueExports.unref(barberRows).length ? (vueExports.openBlock(), vueExports.createBlock("div", {
                      ...
                      vueExports.createVNode("div", { class: "overflow-hidden rounded-[1.25rem] border border-charcoal-200 bg-white/90" }, [
                        vueExports.createVNode(_component_UTable, {
                          ...
                          "branchName-cell": vueExports.withCtx(({ row }) => [
                            vueExports.createVNode("span", { class: "font-medium text-charcoal-950" }, vueExports.toDisplayString(row.original.branchName), 1)
                          ]),
                          "phone-cell": vueExports.withCtx(({ row }) => [
                            vueExports.createTextVNode(vueExports.toDisplayString(row.original.phone || "Не указан"), 1)
                          ]),
                          "login-cell": vueExports.withCtx(({ row }) => [
                            vueExports.createVNode("div", { class: "space-y-1" }, [
                              vueExports.createVNode("p", { class: "font-medium text-charcoal-950" }, vueExports.toDisplayString(row.original.login || "Не указан"), 1),
                              vueExports.createVNode("p", { class: "text-xs text-charcoal-500" }, vueExports.toDisplayString(row.original.role || "Роль не указана"), 1)
                            ])
                          ]),
                          "isActive-cell": vueExports.withCtx(({ row }) => [
                            vueExports.createVNode(_component_SharedStatusBadge, {
                              label: row.original.isActive === false ? "inactive" : "active"
                            }, null, 8, ["label"])
                          ]),
                      ...
                      vueExports.createVNode("div", { class: "flex flex-col gap-3 border-t border-charcoal-200 pt-4 sm:flex-row sm:items-center sm:justify-between" }, [
                        vueExports.createVNode("p", { class: "text-sm text-charcoal-500" }, " Показано " + vueExports.toDisplayString(vueExports.unref(pageFrom)) + "-" + vueExports.toDisplayString(vueExports.unref(pageTo)) + " из " + vueExports.toDisplayString(vueExports.unref(barberRows).length), 1),
                      ...
                      vueExports.createVNode("p", { class: "text-base font-semibold text-charcoal-950" }, " Барберы не найдены "),
                      vueExports.createVNode("p", { class: "mt-2 text-sm text-charcoal-500" }, " Не удалось собрать полный список барберов из аккаунтов и live-профилей. ")
                    ]))
                  ];
                }
              }),
            ...
            _push2(ssrRenderComponent_1(_component_UModal, {
              open: vueExports.unref(detailModalOpen),
              "onUpdate:open": ($event) => vueExports.isRef(detailModalOpen) ? detailModalOpen.value = $event : null,
              class: "sm:max-w-4xl",
              description: vueExports.unref(detailDescription),
              title: vueExports.unref(selectedBarber)?.name || "Детали барбера"
            }, {
              body: vueExports.withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (vueExports.unref(selectedBarber)) {
                    _push3(`<div class="space-y-6"${_scopeId2}><div class="grid gap-3 sm:grid-cols-2 xl:grid-cols-4"${_scopeId2}><!--[-->`);
                    ssrRenderList_1(vueExports.unref(detailMetrics), (metric) => {
                      _push3(`<div class="rounded-[1.25rem] border border-charcoal-200 bg-white/90 p-4"${_scopeId2}><p class="text-xs font-semibold uppercase tracking-[0.18em] text-charcoal-500"${_scopeId2}>${ssrInterpolate_1(metric.label)}</p><p class="mt-3 text-2xl font-semibold text-charcoal-950"${_scopeId2}>${ssrInterpolate_1(metric.value)}</p><p class="mt-2 text-sm leading-6 text-charcoal-500"${_scopeId2}>${ssrInterpolate_1(metric.description)}</p></div>`);
                    });
                    _push3(`<!--]--></div>`);
                    if (vueExports.unref(detailError)) {
                      _push3(`<div class="rounded-[1.25rem] border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700"${_scopeId2}>${ssrInterpolate_1(vueExports.unref(detailError))}</div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    if (vueExports.unref(detailPending)) {
                    ...
                    ssrRenderList_1(vueExports.unref(detailFacts), (fact) => {
                      _push3(`<div class="flex items-start justify-between gap-4 border-b border-charcoal-100 pb-3 last:border-b-0 last:pb-0"${_scopeId2}><span class="text-sm text-charcoal-500"${_scopeId2}>${ssrInterpolate_1(fact.label)}</span><span class="text-right text-sm font-medium text-charcoal-950"${_scopeId2}>${ssrInterpolate_1(fact.value)}</span></div>`);
                    });
                    ...
                    if (vueExports.unref(extraDetailRows).length) {
                      _push3(`<div class="mt-4 space-y-3"${_scopeId2}><!--[-->`);
                      ssrRenderList_1(vueExports.unref(extraDetailRows), ([key, value]) => {
                        _push3(`<div class="rounded-[1rem] border border-charcoal-100 bg-charcoal-50/60 px-4 py-3"${_scopeId2}><div class="flex items-center justify-between gap-4"${_scopeId2}><span class="text-sm font-medium text-charcoal-700"${_scopeId2}>${ssrInterpolate_1(vueExports.unref(toKeyLabel)(key))}</span><span class="text-sm font-semibold text-charcoal-950"${_scopeId2}>${ssrInterpolate_1(value)}</span></div><div class="mt-3 h-2 rounded-full bg-sand-100"${_scopeId2}><div class="h-full rounded-full bg-brass-400" style="${ssrRenderStyle_1({ width: `${Math.min(vueExports.unref(asNumber)(value, 0), 100)}%` })}"${_scopeId2}></div></div></div>`);
                      });
                      _push3(`<!--]--></div>`);
                    } else {
                  ...
                  return [
                    vueExports.unref(selectedBarber) ? (vueExports.openBlock(), vueExports.createBlock("div", {
                      key: 0,
                      class: "space-y-6"
                    }, [
                      vueExports.createVNode("div", { class: "grid gap-3 sm:grid-cols-2 xl:grid-cols-4" }, [
                        (vueExports.openBlock(true), vueExports.createBlock(vueExports.Fragment, null, vueExports.renderList(vueExports.unref(detailMetrics), (metric) => {
                          return vueExports.openBlock(), vueExports.createBlock("div", {
                            key: metric.label,
                            class: "rounded-[1.25rem] border border-charcoal-200 bg-white/90 p-4"
                          }, [
                            vueExports.createVNode("p", { class: "text-xs font-semibold uppercase tracking-[0.18em] text-charcoal-500" }, vueExports.toDisplayString(metric.label), 1),
                            vueExports.createVNode("p", { class: "mt-3 text-2xl font-semibold text-charcoal-950" }, vueExports.toDisplayString(metric.value), 1),
                            vueExports.createVNode("p", { class: "mt-2 text-sm leading-6 text-charcoal-500" }, vueExports.toDisplayString(metric.description), 1)
                          ]);
                        }), 128))
                      ]),
                      vueExports.unref(detailError) ? (vueExports.openBlock(), vueExports.createBlock("div", {
                        key: 0,
                        class: "rounded-[1.25rem] border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700"
                      }, vueExports.toDisplayString(vueExports.unref(detailError)), 1)) : vueExports.createCommentVNode("", true),
                      vueExports.unref(detailPending) ? (vueExports.openBlock(), vueExports.createBlock("div", {
                        key: 1,
                        class: "rounded-[1.25rem] border border-charcoal-200 bg-white/80 px-4 py-5 text-sm text-charcoal-500"
                      }, " Загружаю детальную статистику барбера... ")) : vueExports.createCommentVNode("", true),
                      vueExports.createVNode("div", { class: "grid gap-4 lg:grid-cols-[0.95fr_1.05fr]" }, [
                        vueExports.createVNode("div", { class: "rounded-[1.25rem] border border-charcoal-200 bg-white/90 p-5" }, [
                          vueExports.createVNode("p", { class: "text-xs font-semibold uppercase tracking-[0.18em] text-charcoal-500" }, " Профиль "),
                          vueExports.createVNode("div", { class: "mt-4 space-y-3" }, [
                            (vueExports.openBlock(true), vueExports.createBlock(vueExports.Fragment, null, vueExports.renderList(vueExports.unref(detailFacts), (fact) => {
                              return vueExports.openBlock(), vueExports.createBlock("div", {
                                key: fact.label,
                                class: "flex items-start justify-between gap-4 border-b border-charcoal-100 pb-3 last:border-b-0 last:pb-0"
                              }, [
                                vueExports.createVNode("span", { class: "text-sm text-charcoal-500" }, vueExports.toDisplayString(fact.label), 1),
                                vueExports.createVNode("span", { class: "text-right text-sm font-medium text-charcoal-950" }, vueExports.toDisplayString(fact.value), 1)
                              ]);
                            }), 128))
                          ])
                        ]),
                        vueExports.createVNode("div", { class: "rounded-[1.25rem] border border-charcoal-200 bg-white/90 p-5" }, [
                          vueExports.createVNode("p", { class: "text-xs font-semibold uppercase tracking-[0.18em] text-charcoal-500" }, " Дополнительные метрики "),
                          vueExports.unref(extraDetailRows).length ? (vueExports.openBlock(), vueExports.createBlock("div", {
                            key: 0,
                            class: "mt-4 space-y-3"
                          }, [
                            (vueExports.openBlock(true), vueExports.createBlock(vueExports.Fragment, null, vueExports.renderList(vueExports.unref(extraDetailRows), ([key, value]) => {
                              return vueExports.openBlock(), vueExports.createBlock("div", {
                                key,
              ...
              footer: vueExports.withCtx(({ close }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex w-full flex-wrap items-center justify-between gap-3"${_scopeId2}><p class="text-sm text-charcoal-500"${_scopeId2}> Период: ${ssrInterpolate_1(vueExports.unref(uiStore).statisticsRange.start)} - ${ssrInterpolate_1(vueExports.unref(uiStore).statisticsRange.end)}</p><div class="flex flex-wrap justify-end gap-3"${_scopeId2}>`);
                  _push3(ssrRenderComponent_1(_component_UButton, {
                    color: "neutral",
                    icon: "i-lucide-refresh-cw",
                    loading: vueExports.unref(detailPending),
                    variant: "outline",
                    onClick: ($event) => vueExports.unref(selectedBarber) && loadBarberDetails(vueExports.unref(selectedBarber))
                  }, {
                    default: vueExports.withCtx((_2, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        return [
                          vueExports.createTextVNode(" Обновить детали ")
                        ];
                      }
                    }),
                    _: 2
                  ...
                  return [
                    vueExports.createVNode("div", { class: "flex w-full flex-wrap items-center justify-between gap-3" }, [
                      vueExports.createVNode("p", { class: "text-sm text-charcoal-500" }, " Период: " + vueExports.toDisplayString(vueExports.unref(uiStore).statisticsRange.start) + " - " + vueExports.toDisplayString(vueExports.unref(uiStore).statisticsRange.end), 1),
                      vueExports.createVNode("div", { class: "flex flex-wrap justify-end gap-3" }, [
                        vueExports.createVNode(_component_UButton, {
                          color: "neutral",
                          icon: "i-lucide-refresh-cw",
                          loading: vueExports.unref(detailPending),
