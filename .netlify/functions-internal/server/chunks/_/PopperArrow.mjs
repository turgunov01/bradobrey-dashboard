globalThis.__timing__.logStart('Load chunks/_/PopperArrow');import { ag as unrefElement, F as createContext, m as useForwardExpose, P as Primitive, ap as computedEager } from '../build/server.mjs';
import { v as vueExports } from '../routes/renderer.mjs';

//#region src/shared/useSize.ts
function useSize(element) {
	const size = vueExports.ref();
	const width = vueExports.computed(() => size.value?.width ?? 0);
	const height = vueExports.computed(() => size.value?.height ?? 0);
...
export { PopperAnchor_default as P, PopperRoot_default as a, PopperContent_default as b, PopperArrow_default as c, PopperContentPropsDefaultValue as d };;globalThis.__timing__.logEnd('Load chunks/_/PopperArrow');
//# sourceMappingURL=PopperArrow.mjs.map
