globalThis.__timing__.logStart('Load chunks/_/index2');import { v as vueExports } from '../routes/renderer.mjs';
...
export { useVirtualizer as u };;globalThis.__timing__.logEnd('Load chunks/_/index2');
